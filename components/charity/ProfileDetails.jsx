...
const panes = [
    ...
    { menuItem: 'Revenue and expenses', render: () => <Tab.Pane attached={false}>Tab 2 Content</Tab.Pane> },
    { menuItem: 'Worldwide locations', render: () => <Tab.Pane attached={false}>Tab 3 Content</Tab.Pane> },
