...
const Give = () => (
    <Popup  basic on='click' wide className="give-popup" position='bottom right'
        trigger={(
            ...
            <div className="give-popup-inner">
                <Grid verticalAlign='middle'>
                    <Grid.Row columns={2}>
                        ...
                        Send chairty dollars to a charity or Giving Group<br/>
                        </Grid.Column>
                    ...
                    <div className="give-description">
                        ...
                        <div>
                            ...
                            <br/><br/><Button basic content="Start your own group"/><br/>
                        </div>
                    </div>
                </Grid>
            </div>
        ...
        <Popup.Content>
            <div className="give-popup-inner">
                <Grid verticalAlign='middle'>
                    <Grid.Row columns={2}>
                        <Grid.Column mobile={16} tablet={10} computer={10}>
                            Send charity dollars to other people<br/>
                        </Grid.Column>
                        <Grid.Column mobile={16} tablet={6} computer={6}>
                            <Button fluid basic content="Give"/>
                        </Grid.Column>
