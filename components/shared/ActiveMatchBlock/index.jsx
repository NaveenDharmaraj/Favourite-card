...
const ActiveMatchBlock = (props) => {
    ...
    return (
        <div className="active-match-message mt-3">
            <Message>
                <Grid>
                    <Grid.Column largeScreen={13} tablet={12} mobile={8}>
                    ...
                    {(entityDetails.attributes.activeMatch.matchClose) ?
                        (
                            <Grid.Column largeScreen={3} tablet={4} mobile={8}>
                    ...
                    <Grid.Column largeScreen={13} tablet={12} mobile={16}> 
                        <div className="active-match-comments">
                            <p>
                                {entityDetails.attributes.activeMatch.company} will match {entityDetails.attributes.activeMatch.matchPercent}% for each $1.00 you give to this group, until matching funds run out or expire.
                            </p>
                            <p><span className="active-match-dollar"><b>${formattedBalance}</b></span> matching funds left.</p>
                        </div>
                    </Grid.Column>
                    <Grid.Column largeScreen={3} tablet={4} mobile={0}>
                    </Grid.Column>
                </Grid>
            </Message>
        </div>
