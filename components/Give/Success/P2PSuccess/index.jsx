...
const P2PSuccess = (props) => {
	const { successData, t: formatMessage } = props;
	const { giveData } = successData;
	let name;
	let secondParagraph;
	let thirdParagraph;
	if (giveData) {
		let { frequencyObject, sendDate } = giveData;
	...
	const dashboardLink =
		!_isEmpty(giveData.giveFrom) && giveData.giveFrom.type === 'companies'
...
export default withTranslation(['success'])(memoP2PSuccess);
