            ...
            <Fragment>
                ...
                {/* <List.Item>
                    <List.Content floated='right'>
                        <Dropdown className="rightBottom" icon='ellipsis horizontal'>
                            <Dropdown.Menu>
                                <Modal size="tiny" dimmer="inverted" className="chimp-modal" closeIcon trigger={<Dropdown.Item text='Delete email address' />}>
                                    <Modal.Header>Delete email address?</Modal.Header>
                                    <Modal.Content>
                                        <Modal.Description className="font-s-16">
                    ...
                    <List.Content>
                        <List.Header>tammy.tuba@gmail.com<span className="primary">Primary one</span></List.Header>
                    </List.Content>
                </List.Item>
                <List.Item>
                    <List.Content floated='right'>
                    ...
                    <List.Content>
                        <List.Header>tammy.tuba@hotmail.com</List.Header>
                    </List.Content>
                </List.Item>
                <List.Item>
                    <List.Content floated='right'>
                        <Dropdown className="rightBottom" icon='ellipsis horizontal'>
                            <Dropdown.Menu>
                                <Dropdown.Item text='Resend verification email' />
                                <Modal size="tiny" dimmer="inverted" className="chimp-modal" closeIcon trigger={<Dropdown.Item text='Delete email address' />}>
                                    <Modal.Header>Delete email address?</Modal.Header>
                                    <Modal.Content>
                                        <Modal.Description className="font-s-16">
                    ...
                    <List.Content>
                        <List.Header>tammy.tuba@charitableimpact.com<span className="pending">PENDING VERIFICATION</span></List.Header>
                    </List.Content>
                </List.Item> */}
            </Fragment>
        );
