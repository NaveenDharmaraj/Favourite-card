                    ...
                    <div className='createNewGrpheader'>
                        ...
                        <div className="flowBreadcrumb">
                            <Breadcrumb size="mini">
                                <Breadcrumb.Section active>Basic settings</Breadcrumb.Section>
                                <Breadcrumb.Divider icon='right chevron' />
                                <Breadcrumb.Section>About the group</Breadcrumb.Section>
                                <Breadcrumb.Divider icon='right chevron' />
                                <Breadcrumb.Section >Pics & video</Breadcrumb.Section>
                                <Breadcrumb.Divider icon='right chevron' />
