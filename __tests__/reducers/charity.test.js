...
describe('Testing charity profile Reducer', () => {
    ...
    test('Testing GET_BENEFICIARY_DONEE_LIST state', () => {
        ...
        expect(newState).toEqual(modifiedPayload);
    });

    // test('Testing GET_BENEFICIARY_DONEE_LIST state with loadmore', () => {
    //     const type = 'GET_BENEFICIARY_DONEE_LIST';
    //     const payload = {
    //         donationDetails: donationDetails._embedded.donee_list,
    //         totalPages: 6,
    ...
    test('Testing CHARITY_BUTTON_LOADER_STATUS state', () => {
        const type = 'CHARITY_BUTTON_LOADER_STATUS';
        const payload = {
